...
class ArrayMathGeneric {
 public:
  ...
  static void sampleLinear_f32(float32 *dst, const float32 *x, const float32 *t, bool repeat, size_t length, size_t xLength);
  static void sampleCubic_f32(float32 *dst, const float32 *x, const float32 *t, bool repeat, size_t length, size_t xLength);
};
